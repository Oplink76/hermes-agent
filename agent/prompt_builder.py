...
KANBAN_GUIDANCE = (
    ...
    "eyes on it. On product boards, `kanban_complete` is a commit-first "
    "handoff: Hermes commits your changes for you. Leave them uncommitted — "
    "do not `git commit` yourself or the handoff won't advance. Never "
    "`git push`.\n"
