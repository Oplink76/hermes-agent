...
@doctor_check()
def _check_gateway_runtime_identity(should_fix: bool, f: Finding) -> None:
    ...
    if not isinstance(identity, dict):
        ...
        f.manual_issues.append("Restart the gateway so it publishes runtime identity")
        return
    ...
    if identity_pid != live_pid:
        ...
        f.manual_issues.append("Reconcile the gateway service and its runtime identity")
        return
