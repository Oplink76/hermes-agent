...
_with_upstream_sync_status = late("_with_upstream_sync_status")
_pending_sync_deployment_state = late("_pending_sync_deployment_state")
_upstream_sync_status_path = late("_upstream_sync_status_path")
...
async def update_hermes():
    ...
    if pending_deployment_state is not None or (
        ...
        return _update_refused(
            "upstream_sync_update_blocked", message, "managed by autonomous upstream sync",
        )
