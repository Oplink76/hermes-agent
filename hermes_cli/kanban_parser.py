...
_BOARD_SPECS = [
    ...
    _cmd("create", [
        ...
        _arg("--preset", choices=sorted(kb.BOARD_PRESETS), help="Visible board workflow preset"),
...
_SPECS = [
    ...
    _cmd("create", [
        ...
        _arg("--source-policy", choices=("none", "required", "forbidden"), default="none",
             help="Source commit policy for the execution contract"),
        _arg("--workflow-template-id", metavar="ID"),
