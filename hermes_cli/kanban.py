...
from hermes_cli.kanban_output import _ATTACHMENT_FIELDS
from hermes_cli.kanban_output import _RUNS_RUN_FIELDS
from hermes_cli.kanban_output import _SHOW_RUN_FIELDS
from hermes_cli.kanban_output import _bulk_apply
from hermes_cli.kanban_output import _err
from hermes_cli.kanban_output import _fmt_counts
from hermes_cli.kanban_output import _fmt_task_line
from hermes_cli.kanban_output import _fmt_ts
from hermes_cli.kanban_output import _json_out
from hermes_cli.kanban_output import _obj_dict
...
from hermes_cli.kanban_ops import _cmd_daemon
...
from hermes_cli.kanban_ops import _cmd_repair
...
def _cmd_claim(args: argparse.Namespace) -> int:
    with kbc.connect_closing() as conn:
        ...
        try:
            ...
            kb.reclaim_task(conn, task.id, reason=f"workspace provisioning failed: {exc}")
            return _err(f"cannot claim {task.id}: workspace provisioning failed: {exc}")
