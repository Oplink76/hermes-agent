...
def test_shell_command_argvs_is_quote_aware_and_unwraps_command_prefixes():
    from tools.approval_detection import shell_command_argvs
...
def test_shell_command_has_redirection_ignores_quoted_operators():
    from tools.approval_detection import shell_command_has_redirection
...
def test_shell_command_output_paths_are_quote_aware():
    from tools.approval_detection import shell_command_output_paths
