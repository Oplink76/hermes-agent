...
def _tool_defs_cache_key(
    ...
    return (
        ...
        bool(os.environ.get("HERMES_WORK_INBOX_INTAKE")), bool(skip_tool_search_assembly),
...
def _select_tool_names(enabled_toolsets: Optional[List[str]], disabled_toolsets: Optional[List[str]], quiet_mode: bool) -> set:
    ...
    if enabled_toolsets is not None:
        ...
        if ((os.environ.get("HERMES_KANBAN_TASK") or os.environ.get("HERMES_WORK_INBOX_INTAKE")) and not _is_delegated_child_context()
